( function( $ ) {
	var cookieValue = document.cookie.replace( /(?:(?:^|.*;\s*)gdpradscompliance\s*\=\s*([^;]*).*$)|^.*$/, '$1' ),
		overlay = $( '#gdpr-ads-compliance' ),
	...
	function accept( event ) {
		...
		document.cookie = 'gdpradscompliance=' + expireTime.getTime() + ';path=/;expires=' + expireTime.toGMTString();
